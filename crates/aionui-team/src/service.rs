...
impl TeamSessionService {
    ...
    pub async fn transfer_owner(&self, team_id: &str, target_user_id: &str) -> Result<(), TeamError> {
        ...
        self.repo
            ...
            .await?;
        self.broadcast_team_list_changed(target_user_id, team_id, "updated");
        for conversation_id in conversation_ids {
            self.broadcast_conversation_list_changed(target_user_id, &conversation_id, "updated");
        }
        Ok(())
    }
    ...
    fn broadcast_conversation_list_changed(&self, user_id: &str, conversation_id: &str, action: &str) {
        ...
        self.broadcaster.broadcast(WebSocketMessage::new(
            ...
            serde_json::json!({ "user_id": user_id, "conversation_id": conversation_id, "action": action }),
        ));
    }
