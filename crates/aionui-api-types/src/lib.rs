...
pub use acp::{
    ...
    AgentSessionChildTask, AgentSessionItem, AgentSessionItemKind, AgentSessionListQuery, AgentSessionScope,
    AgentSessionSnapshot, AgentSessionSummary, AgentSessionTurn, ConfigOptionConfirmation, DetectCliRequest,
    DetectCliResponse, GetConfigOptionsResponse, GetModelInfoResponse, ModelInfoEntry, ModelInfoPayload,
    ProbeModelRequest, SetConfigOptionRequest, SetConfigOptionResponse, SetModeRequest, SetModelRequest,
    SideQuestionRequest, SideQuestionResponse, TryConnectCustomAgentRequest, TryConnectCustomAgentResponse,
    WorkspaceBrowseQuery, WorkspaceEntry, WorkspaceSearchMatchKind, WorkspaceSearchMode,
};
...
pub use conversation::{
    ...
    ConversationRuntimeStateKind, ConversationRuntimeSummary, ConversationTurnPreview,
...
pub use project::{
    AttachFolderRequest, CreateProjectRequest, CreateProjectResponse, ProjectDetailResponse, ProjectEntry,
